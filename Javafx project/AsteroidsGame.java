...
public class AsteroidsGame {
    ...
    public void gameScene() {
        ...
        //Event Listener attached to the game  scene, adds a key to an arraylist when pressed
        ...
        new AnimationTimer() {
            ...
            public void handle(long now) {
                //1. Reaction to keys
                /* The code for the reaction to keys was written using video https://www.youtube.com/watch?v=9xsT6Z6HQfw*/
...
//                    Point2D SafeLocation = generator.generateSafePoint(enemies);
                ...
                for (Bullet bullet: playerBullets) {
                    ...
                    for (Asteroid existingAsteroid: asteroids) {
                        ...
                        if(bullet.collided(existingAsteroid) && existingAsteroid.getSize() == AsteroidSize.MEDIUM) {
                            currentScore += 20;
                            scoreText.setText("Current Score: " + currentScore);
                        ...
                        if(bullet.collided(existingAsteroid) && existingAsteroid.getSize() == AsteroidSize.SMALL) {
                            ...
                            // add extra life
                        if (currentScore % 1000 == 0 && currentScore > playerLives * 1000 && Constant.PLAYER_MAX_LIVES >=playerLives) {
                            playerLives++;
