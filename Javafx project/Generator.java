...
public class Generator {
    ...
    public static List<Asteroid> generateInitAsteroids(int currentLevel) {
        ...
        for (int i = 0; i < currentLevel; i++) {
            ...
            do {
                collided = false;
                newAsteroid = new Asteroid(Generator.rdm.nextInt(Constant.WIDTH), Generator.rdm.nextInt(Constant.HEIGHT), AsteroidSize.LARGE);
    ...
    public static AlienShip generateAlienShip() {
        ...
        //restrict the range of y. let the whole ship on screen to avoid split ship while moving
